...
public class HospitalDaoImpl implements HospitalDao {
	...
	public HospitalDto select(Integer hNo) throws Exception {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectOne("mapper.hospital.select", hNo);
	...
	public HosDetailDto selectHosDetail(Integer hNo) throws Exception {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			...
			return session.selectOne("mapper.hospital.selectHosDetail", hNo);
		}
	}
	...
	public HosDetailDto selectDocDetail(Integer hNo) throws Exception {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectOne("mapper.hospital.selectHosDetailDoc", hNo);
	...
	public Integer selectCount() throws Exception {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			...
			return session.selectOne("mapper.hospital.selectCount");
		}
	}
	...
	public List<HosSearchListDto> selectList(HosSearchDto hosSearch) throws Exception {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			...
			return session.selectList("mapper.hospital.selectListRes",hosSearch);
		}
	}
	...
	public Integer addHospital(HospitalDto hosDto) {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			...
			session.insert("addHospital", hosDto);
			session.commit();
...
//		return sqlsession.selectOne("mapper.hospital.selectListResCnt", hosSearchDto);
	...
	public int hosWaitCount() {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectOne("hosWaitcount");
	...
	public List<HospitalDto> selectWaitHos(Map<String, Object> page) {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectList("selectWaithos", page);
	...
	public int hosWaitCountByKeyword(String keyword) {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectOne("hosWaitCountByKeyword", keyword);
	...
	public List<HospitalDto> selectWaitHosByKeyword(Map<String, Object> page) {
		...
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectList("selectWaitHosByKeyword", page);
	...
	public List<HospitalDto> joinSearchHosName(String keyword) {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			return session.selectList("joinSearchHosName", keyword);
	...
	public HospitalDto checkHosAuthCode(Map<String, Object> hosMap) {
		try (SqlSession session = MybatisSqlSessionFactory.getSessionFactory().openSession()) {
			...
			return session.selectOne("checkHosAuthCode", hosMap);
		}
	}
