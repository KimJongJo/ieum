 ...
 */
@WebServlet("/exam/exam5")
public class ExamExam5 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("navPath2", "/ieum/exam/exam5");
		request.setAttribute("navPathName2", "조울증(청소년)");
		request.setAttribute("navcurPage", "검진");
		
		request.getRequestDispatcher("/exam/examQues5.jsp").forward(request, response);
	}
