...
/**
 * Servlet implementation class SignUpHosManager
 */
@WebServlet("/signUp2")
public class SignUpHosManager extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SignUpHosManager() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		MemberDto memberDto = new MemberDto(userId, name, birthDate, password,
		gender, tel, email, userType, major, hNo); MemberService memberService = new
		MemberServiceImpl();
		 
		memberService.normalJoin(memberDto);
		 
		session.removeAttribute("email"); session.removeAttribute("userType");
