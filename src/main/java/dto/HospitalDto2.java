...
public class HospitalDto2 {
		...
		public HospitalDto2(Integer hNo, String hNm, Integer categoryNo, String info1, String info2, String hAddress,
				String hLocationY, String hLocationX, String transferInfo, String holidayInfo, String hTel,
				String hLink, String introcudeNote, Integer fileNo, Date hCreated, Date hUpdated, String status,
				String hCode) {
			super();
			this.hNo = hNo;
			this.hNm = hNm;
		...
		public HospitalDto2(String hNm, Integer categoryNo, String info1, String info2, String transferInfo) {
			super();
			this.hNm = hNm;
			this.categoryNo = categoryNo;
			this.info1 = info1;
		...
		public String toString() {
			return "HospitalDto2 [hNo=" + hNo + ", hNm=" + hNm + ", categoryNo=" + categoryNo + ", info1=" + info1
					...
					+ hCreated + ", hUpdated=" + hUpdated + ", status=" + status + ", hCode=" + hCode + "]";
		}
