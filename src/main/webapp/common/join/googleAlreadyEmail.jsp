    ...
    <c:import url="/common/header/header.jsp" charEncoding="UTF-8"/>
		<div class="main">
		    <div class="main-div">
		        ...
		        <div class="sub-div">
		            <span>현재 로그인한 구글 이메일과 동일한 계정이 이미 존재합니다.</span>
		            <span>병합하면 구글 로그인으로 기존 계정에 바로 접속할 수 있습니다.</span>
		            <span class="type">
		        ...
		        <div id="pw-input-div" class="pwDiv">
		        	<input id="email" type="hidden" value="${sessionScope.googleDto.email}">
		        	<input id="id" type="hidden" value="${sessionScope.googleDto.id}">
		        ...
		        <div class="btn-div">
		            <button onclick="location.href='/ieum/social/googleSignUp'" class="home-btn">새로 가입</button>
